...
//        binding.blank15.setImageResource(symbolResId)
        ...
        // 로그 잘 들어옴
        Log.d("imprintingView.kt", "" + text)
        Log.d("imprintingView.kt", "" + levelText)
        Log.d("imprintingView.kt", "" + overCountText)
    ...
    fun setText(text: String, levelText: String, overCountText: String) {
        ...
        Log.d("imprintingView.kt", "setText: " + text)
        Log.d("imprintingView.kt", "setText: " + levelText)
        Log.d("imprintingView.kt", "setText: " + overCountText)
    }
}